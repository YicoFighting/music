...
function formatAlbumItem(raw) {
  ...
  return {
    ...
    _musicList:
      (_b =
        (_a = raw === null || raw === void 0 ? void 0 : raw.tracks) === null ||
        _a === void 0
          ? void 0
...
function formatMusicSheetItem(raw) {
  ...
  return {
    ...
    artistItem: {
      ...
      avatar:
        ((_c = raw.artist) === null || _c === void 0 ? void 0 : _c.image) ||
        ((_d = raw.artist) === null || _d === void 0 ? void 0 : _d.image_base),
      name: (_e = raw.artist) === null || _e === void 0 ? void 0 : _e.name,
      url_slug:
        (_f = raw.artist) === null || _f === void 0 ? void 0 : _f.url_slug,
    },
...
async function searchBase(query, page, show) {
  ...
  const results = (
    await axios_1.default.get("https://api.audiomack.com/v1/search", {
      headers,
...
async function getRecommendSheetTags() {
  const rawHtml = (await axios_1.default.get("https://audiomack.com/playlists"))
    .data;
  const $ = (0, cheerio_1.load)(rawHtml);
  const script = $("script#__NEXT_DATA__").text();
  const jsonObj = JSON.parse(script);
  ...
  return [
    {
      ...
      data: genres.map((it) => {
        ...
        return Object.assign(Object.assign({}, it), {
          type: "trending",
          id: (_a = it.url_slug) !== null && _a !== void 0 ? _a : it.title,
        });
      }),
    },
    {
